package com.menzo.User_Service.WishlistCart.Wishlist.Controller;

import com.menzo.User_Service.GlobalComponents.Enum.Response;
import com.menzo.User_Service.WishlistCart.Common.Service.WishlistCartCommandService;
...
public class WishlistCommandRestController {
    ...
    @Autowired
    private WishlistCartCommandService wishlistCartCommandService;
    ...
    public ResponseEntity<?> moveWishlistItemToCart(@RequestHeader("roles") String roles,
        ...
        if (roles.equals("CUSTOMER")) {
            ...
            boolean itemMoved = wishlistCartCommandService.moveWishlistItemToCart(userEmail, wishlistItemId);
