...
// *************** CRUD functions on variations and options ***************
    ...
    function addVariation(variationId = null, variationName = "") {
...
//        });
        ...
        header.onclick = async () => {
            ...
            if(accordion.dataset.loaded === "false") {
                ...
                if(added) {
                    ...
                    alert("Unable to load options. Try again later.");
                }
            } else {
    ...
    async function addOptions(variationId, content) {
        ...
        try {
            ...
            if(!response.ok) throw new Error("Failed to load options for variation ID: ", variationId);
