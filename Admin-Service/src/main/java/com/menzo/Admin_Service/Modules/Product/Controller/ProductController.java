package com.menzo.Admin_Service.Modules.Product.Controller;

import com.menzo.Admin_Service.Apis.ApiService;
import com.menzo.Admin_Service.Modules.Product.Dto.NewProductDto;
import com.menzo.Admin_Service.Modules.Product.Dto.NewProductItemDto;
import com.menzo.Admin_Service.Modules.Product.Service.CategoriesService;
import com.menzo.Admin_Service.Modules.Product.Service.ProductRetrievalService;
...
//        model.addAttribute("colorsList", colorsDto.getOptions());
    ...
    public String getProductDetails(@RequestParam("id") Long productId,
        ...
        return "Products/product-summary";
    }
    ...
    public String getAddDiscountForm() {
        return "DiscountsAndCoupons/add-discount-form";
    }

    //  discount summary - page
    @GetMapping("/discount-summary")
    public String getDiscountSummary() {
        return "DiscountsAndCoupons/discount-summary";
    }
