...
public class GlobalExceptionHandler {
    ...
    //    1. Bean validation / Binding result validation errors (also works for Request Part binding errors)
...
//    --------
    ...
    //  @RequestParam / @PathVariable validation errors (@Min, @Max, etc.)
...
//    }
    ...
    public ResponseEntity<?> handle(MethodArgumentTypeMismatchException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body("Invalid value for parameter: " + ex.getMessage());
    }
