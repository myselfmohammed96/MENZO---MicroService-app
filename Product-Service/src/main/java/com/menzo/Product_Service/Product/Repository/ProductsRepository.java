...
public interface ProductsRepository extends JpaRepository<Product, UUID>, JpaSpecificationExecutor<Product>, ProductsRepositoryCustom {
    ...
    List<Product> findByProductIdIn(List<UUID> selectionList);

    List<Product> findBySubCategory_CategoryId(UUID categoryId);
